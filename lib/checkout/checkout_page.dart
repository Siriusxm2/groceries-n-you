                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Theme(
                            data: Theme.of(context).copyWith(
                              unselectedWidgetColor: const Color(0xffFFCE81),
                            ),
                            child: Column(
                              children: [
                                ListTile(
                                  ...
                                  leading: Image.asset('assets/cash_pay.png'),
                                  trailing: Radio(
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          orderInfoName = _nameController.text;
                          orderInfoEmail = _emailController.text;
                          orderInfoAddress = _addressController.text;
                          orderInfoPhone = _phoneController.text;
                          orderInfoDeliveryDate = _dateController.text;
                          orderInfoDeliveryHour = chosenHour;
                          orderInfoPayment =
                              _char == RadioValues.cash ? 'Cash' : 'Card';
